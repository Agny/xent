...
case class WorldCell(x: Int, y: Int, building: Option[Facility] = None, resource: Option[Extractable] = None, city: Option[City] = None, owner: Option[UserId] = None) extends Cell
